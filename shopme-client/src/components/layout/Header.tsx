...
const Header: React.FC = () => {
    ...
    const fetchFeatureCategories = async () => {
      ...
      try {
        ...
        const organizedCategories =
          featureCategoryService.organizeFeatureCategories(categories)
  ...
  const handleFeatureCategoryClick = (
    featureItem: FeatureCategoryItem | FeatureSubcategoryItem,
  ...
  const productCategoriesContent = (
    <div
      ...
      style={{ maxWidth: '600px', width: '100%', padding: '10px' }}
    >
      {loading ? (
          ...
          {featureCategories.map((category) => (
            <div key={category.id} style={{ width: '33%', padding: '10px' }}>
              ...
              >
                <Link
                  to={ROUTES.PRODUCTS}
                  onClick={(e) => handleFeatureCategoryClick(category, e)}
          ...
          <div className='flex justify-between items-center text-sm'>
            <div className='flex items-center space-x-4'>
              <span className='text-gray-600'>
                <PhoneOutlined style={{ marginRight: '4px' }} /> Hotline: 1900
                1234
              </span>
            </div>
            <div className='flex items-center space-x-4'>
          ...
          <div className='flex items-center justify-between h-12'>
            <nav className='flex space-x-8'>
              <Link
                to={ROUTES.HOME}
                className={`text-gray-600 hover:text-primary ${
                  currentPath === ROUTES.HOME ? 'text-primary font-medium' : ''
                }`}
              >
                Trang chủ
              </Link>
              ...
              >
                <Link
                  ...
                  className={`text-gray-600 hover:text-primary flex items-center ${
                    currentPath.startsWith(ROUTES.PRODUCTS)
              ...
              <Link
                to={ROUTES.NEWS}
                className={`text-gray-600 hover:text-primary ${
                  currentPath === ROUTES.NEWS ? 'text-primary font-medium' : ''
                }`}
              >
                Tin tức
              </Link>
              ...
              <Link
                to={ROUTES.ABOUT}
                className={`text-gray-600 hover:text-primary ${
                  currentPath === ROUTES.ABOUT ? 'text-primary font-medium' : ''
                }`}
              >
                Giới thiệu
              </Link>
            ...
            <div>
              <Link
                ...
                className='text-gray-600 hover:text-primary'
              >
                <OrderedListOutlined style={{ marginRight: '4px' }} /> Tra cứu
                đơn hàng
              </Link>
            </div>
          </div>
